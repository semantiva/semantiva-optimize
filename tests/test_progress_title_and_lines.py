...
def test_polynomial_observer_title_and_lines(tmp_path, monkeypatch):
    ...
    step_event1 = StepEvent(
        iter=1, x=theta1, f=10.5, feasible=True, violation=0.0,
        run_id=None, is_best=True, meta={"strategy": "test"}
    )
    ...
    step_event2 = StepEvent(
        iter=2, x=theta2, f=12.3, feasible=True, violation=0.0,
        run_id=None, is_best=False, meta={"strategy": "test"}
    )
    ...
    # End event
    end_event = EndEvent(
        reason="completed", best_x=theta1, best_f=10.5,
        run_id=None, meta={"strategy": "test"}
    )
...
def test_polynomial_lines_separate_current_and_best():
    ...
    theta1 = [0.0, 0.0, 1.0]
    step1 = StepEvent(
        iter=1, x=theta1, f=5.0, feasible=True, violation=0.0,
        run_id=None, is_best=True, meta={}
    )
    ...
    theta2 = [1.0, 1.0, 0.5]
    step2 = StepEvent(
        iter=2, x=theta2, f=8.0, feasible=True, violation=0.0,
        run_id=None, is_best=False, meta={}
    )
